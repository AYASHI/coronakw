    ...
    <SafeAreaView style={styles.saveArea}>
      <ScrollView style={styles.container}>
        {question.questionType === 3 && (
          <TemperatureView onTemperatureConfirm={onTemperatureConfirm} />
        )}
